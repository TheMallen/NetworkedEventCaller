    ...
    public class UdonBehaviourEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(Application.isPlaying))
            {
                ...
                {
                    SyncTypes selected = (SyncTypes)EditorGUILayout.EnumPopup("Synchronization Method", udonTarget.Reliable ? SyncTypes.Manual : SyncTypes.Continuous);
                    ...
                    if (udonTarget.Reliable)
                        EditorGUILayout.LabelField("Manual replication is intended for infrequently-updated variables of small or large size, and will not be tweened.");
                    else
                        EditorGUILayout.LabelField("Continuous replication is intended for frequently-updated variable of small size, and will be tweened.");
                }
